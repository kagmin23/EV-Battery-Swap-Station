...
export interface TransactionApiResponse {
    ...
    stationId: string;
    station_id?: string; // Backend field
    batteryIdGiven?: string;
    battery_given?: string; // Backend field
    batteryIdReturned?: string;
    battery_returned?: string; // Backend field
    amount: number;
    cost?: number; // Backend field (alternative to amount)
    transactionType: string;
    transaction_type?: string; // Backend field
    status: string;
    paymentMethod?: string;
    payment_method?: string; // Backend field
    description?: string;
    createdAt: string;
    created_at?: string; // Backend field
    updatedAt: string;
    updated_at?: string; // Backend field
    transaction_time?: string; // Backend field (alternative to createdAt)
